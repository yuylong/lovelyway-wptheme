...
function fashion_blogging_admin_enqueue_scripts(){

    wp_enqueue_style( 'fashion-blogging-admin-css', get_template_directory_uri() . '/assets/css/admin.css', false );

	wp_enqueue_script( 'fashion-blogging-admin-script', get_theme_file_uri('/js/admin.js'), array( 'jquery' ), '', true );
    wp_localize_script( 'fashion-blogging-admin-script', 'fashion_blogging_ajax_object',
        array( 'ajax_url' => admin_url( 'admin-ajax.php' ) )
    );
}
add_action( 'admin_enqueue_scripts', 'fashion_blogging_admin_enqueue_scripts' );

add_action( 'wp_ajax_install_act_plugin', 'fashion_blogging_admin_install_plugin' );

function fashion_blogging_admin_install_plugin() {
